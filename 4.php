                   ...
                   <div class="title">
                    <h1 style="text-align: center;"><a href="covid.php"><span class="headcov">COVID19 </span></a><a href="https://en.wikipedia.org/wiki/karnataka">
                        ...
                        <div class="header"><div id="mySidepanel" class="sidepanel">
                            ...
                            <br>
                            <br>
                            <h1 style="text-align: center;"><font color="black">Tumakuru</font></h1>
                            <hr>
                            <marquee behavior="scroll" direction="left"><font face="Times New Roman" color="black" size="4">Helpline: 91+ 9889223311    Toll: 911 Helpline E-mail: covidhelp@gov.in</font></marquee>
                             ...
                             <div class="center-screen">
                                <div class="box">
                                    ...
                                    <h4 style="text-align:center;">cases in Tumakuru </h4>
                                    <div class="flex-container">
                                        <div class="row">
                                          <div class="box1"><div class="flex-item">'
                                          
                                          <h4 style="text-align:center;">19808</h3>
                                            <h5 style="text-align:center;">Total cases</h4>
                                          </div> </div>
                                        </div>
                                        <div class="box2">
                                          <div class="flex-item">'
                                            <h4 style="text-align:center;">16789</h3>
                                        ...
                                        <div class="row">
                                          <div class="box3"><div class="flex-item">'
                                              <br>
                                              <h4 style="text-align:center;">34</h3>
                                ...
                                <br>
    <hr>
                                <h2 style="text-align:center;">Total population of Tumakuru<br> 19,999 </h2>
                                <br>
                                <br>
                                    ...
                                    <td><td> <div class="box4">
                                        <div class="flex-item">'
                                          <h4 style="text-align:center;">Confirmed per 1000</h4>
                                              ...
                                              <h5 style="text-align:center;">99900 per 1L</h5>
                                            </td>
                                    <td><td> <div class="box4">
                                        <div class="flex-item">'
